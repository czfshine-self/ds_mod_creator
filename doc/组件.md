...
max:默认100 -- 你的事物能够食用多少的物品
hungerrate,hurtrate: 默认1 -- 饥饿的速度
burning: 默认 true -- 是否会饿
period: 默认1 -- 减低饥饿值的间隔
...
canbepickedup: 默认true -- 能够被捡起
onpickupfn: function -- 当被捡起时调用
